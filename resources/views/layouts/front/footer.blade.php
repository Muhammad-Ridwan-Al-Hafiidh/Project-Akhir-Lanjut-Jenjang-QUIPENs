...
<div class="container-fluid bg-primary text-light footer wow fadeIn" data-wow-delay="0.1s">
    <div class="container py-5 px-lg-5">
        <div class="justify-content-center row g-5">
            <div class="col-md-6 col-lg-3">
                <p class="section-title text-white h5 mb-4">Address<span></span></p>
                <p><i class="fa fa-map-marker-alt me-3"></i>dukuh setro 8A, Surabaya, Indonesia</p>
                <p><i class="fa fa-phone-alt me-3"></i>081316777541</p>
                <p><i class="fa fa-envelope me-3"></i>ridwanpens123@gmail.com</p>
