    ...
    <div class="card shadow-sm">
        <div class="card-header bg-primary text-white py-3">
            <h6 class="m-0 fw-bold">
                <i class="fas fa-question-circle me-2"></i> Test Question
            </h6>
        </div>
        <div class="card-body">
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control" id="descriptionofquestion" wire:model="question_body" rows="4" placeholder="Enter the question description"></textarea>
            </div>
            ...
            <div class="mb-3">
                ...
                <p class="text-muted small mb-2">Select the correct answer</p>
                ...
                <div class="alert alert-warning py-2">
                    <i class="fas fa-exclamation-triangle me-1"></i> No answer options added yet.
                </div>
                @endforelse
